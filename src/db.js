...
export const products = [
  {
    ...
    price: 2900,
    card_img: require("./assets/baxter.png"),
    product_img: require("./assets/baxter1.png"),
    other_images: [
      require("./assets/baxter2.png"),
      require("./assets/baxter3.png"),
      require("./assets/baxter4.png"),
    ],
    info:
